...
int main() {
  ...
  18:	75 34                	jne    4e <main+0x4e>
    printf(1, "%d - wait...\n", getpid());
  1a:	e8 23 03 00 00       	call   342 <getpid>
  1f:	51                   	push   %ecx
  20:	50                   	push   %eax
  21:	68 40 07 00 00       	push   $0x740
  26:	6a 01                	push   $0x1
  28:	e8 f3 03 00 00       	call   420 <printf>
    fwait(1, 42);
  2d:	58                   	pop    %eax
  2e:	5a                   	pop    %edx
  2f:	6a 2a                	push   $0x2a
  31:	6a 01                	push   $0x1
  33:	e8 2a 03 00 00       	call   362 <fwait>
    printf(1, "go go go!\n");
  38:	59                   	pop    %ecx
  39:	58                   	pop    %eax
  3a:	68 4e 07 00 00       	push   $0x74e
  3f:	6a 01                	push   $0x1
  ...
  exit();
  49:	e8 74 02 00 00       	call   2c2 <exit>
    sleep(500);
  4e:	83 ec 0c             	sub    $0xc,%esp
  51:	68 f4 01 00 00       	push   $0x1f4
  56:	e8 f7 02 00 00       	call   352 <sleep>
    printf(1, "%d - notify...\n", getpid());
  5b:	e8 e2 02 00 00       	call   342 <getpid>
  60:	83 c4 0c             	add    $0xc,%esp
  63:	50                   	push   %eax
  64:	68 59 07 00 00       	push   $0x759
  69:	6a 01                	push   $0x1
  ...
  72:	6a 2a                	push   $0x2a
  74:	6a 01                	push   $0x1
  76:	e8 ef 02 00 00       	call   36a <fwake>
 ...
 42c:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5bb:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c0:	bb 69 07 00 00       	mov    $0x769,%ebx
 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 08 0a 00 00       	mov    %eax,0xa08
    p->s.size += bp->s.size;
