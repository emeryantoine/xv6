 ...
 6ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 87b:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 880:	bb 4a 0a 00 00       	mov    $0xa4a,%ebx
...
free(void *ap)
{
 ...
 891:	a1 70 0d 00 00       	mov    0xd70,%eax
{
 ...
 8b6:	73 18                	jae    8d0 <free+0x40>
{
 ...
 8e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8e9:	a3 70 0d 00 00       	mov    %eax,0xd70
}
 8ee:	5b                   	pop    %ebx
 8ef:	5e                   	pop    %esi
 8f0:	5f                   	pop    %edi
 ...
 90a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 90d:	a3 70 0d 00 00       	mov    %eax,0xd70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 929:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 92c:	8b 15 70 0d 00 00    	mov    0xd70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
